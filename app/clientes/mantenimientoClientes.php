...
require_once '../../api/clientes/admMantenimientoClientes.php';

require_once '../dependenciasHead.php';

require_once '../../api/clientes/admMantenimientoClientesAJAX.php';
...
require_once '../../layout/clientes/mantenimientoClientesComponent.php';
