        ...
        <div class="tab-content">
          <div class="tab-pane active" id="one" role="tabpanel" aria-labelledby="one-tab"></br>
            ...
            <div class="form-group row ">
              ...
              <div class=" col-3">
                <div class="form-group row ">
                  <a for="Mora" class="col-sm-4 col-form-label">Dia Cierre</a>
                  <div class="col-sm-5">
                  ...
                  <a for="Llamadas" class="col-sm-4 col-form-label">Ciclo Inicial</a>
                  <div class="col-sm-5">
                  ...
                  <a for="Llamadas" class="col-sm-4 col-form-label">Ciclo Cierre</a>
                  <div class="col-sm-5">
            ...
            <div class="form-group col-12 row ">
              <div class="form-group col-12 row ">
                <div class="col-2"></div>
                <a for="Sldo" class="col-sm-1 col-form-label">Sldo Act</a>
                <div class="col-sm-1">
                ...
                <a for="Interes" class="col-sm-1 col-form-label">Interes Mora</a>
                <div class="col-sm-1">
                ...
                <a for="Atraso" class="col-sm-1 col-form-label">Total Factura</a>
                <div class="col-sm-1">
                ...
                <a for="Convenio" class="col-sm-1 col-form-label">Cuota</a>
                <div class="col-sm-1">
