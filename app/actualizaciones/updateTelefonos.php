...
$rt =  isset($_GET["rt"]) ? $_GET["rt"]  : '';
    ...
    $windowHome = '../../home.php';
    $NIUMENU = 4;
    $title = 'ACTUALIZACION DE TELEFONOS';
    $return = 'index.php';
    ...
    require_once '../../api/actualizaciones/admUpdateTelefonos.php';

    require_once '../dependenciasHead.php';

    require_once '../../api/varrGlobal.php';

    require_once '../../api/actualizaciones/admUpdateTelefonosAjax.php';
    ...
    require_once '../../layout/actualizaciones/updateTelefonos.php';
