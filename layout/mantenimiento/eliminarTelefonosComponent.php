            ...
            <div class="row">
                ...
                <div class="col-lg-12 fondo">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="col-form-label" for="inputSuccess"></i> PROPIETARIO</label>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="col-form-label" for="inputSuccess"></i> NUMERO</label>
                                <input type="text" class="form-control " id="buscarCODICLIE" name="buscarCODICLIE" placeholder="Ingrese el dato ...!">
                            </div>
                        </div>
                        <div class="col-md-1">
                            <div class="form-group">
                                <label class="col-form-label" for="inputSuccess"></i> Eliminar Bloque</label></br>
                                <button type="button" class="btn btn-info" onclick="fntEliminarBloque()"><i class="fas fa-2x fa-minus-circle"></i></button>
                            </div>
                        </div>
                        <div class="col-md-12"></br></div>
                        <div class="col-md-12">
