                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-3 fondo">
                                <div class="form-group">
                                    <label class="col-form-label" for="inputSuccess"></i> Fecha</label>
                                    <input type="date" class="form-control " id="buscarfpropago" name="buscarfpropago" placeholder="Ingrese fecha...!">
                                </div>
                            </div>
                        </div>
                    </div>
