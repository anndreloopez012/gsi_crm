...
<?php
    ...
    $windowHome = '../../home.php';
    $NIUMENU = 7;
    $title = 'Gestion De Cobros - Unicomer';
    $return = 'index.php';
    ...
    require_once '../../api/gestion/admUnicomer.php';

    require_once '../dependenciasHead.php';
    
    require_once '../../api/gestion/admUnicomerAJAX.php';
    ...
    require_once '../../layout/gestion/unicomerComponent.php';
